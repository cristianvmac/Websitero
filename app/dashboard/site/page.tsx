    ...
    <div className="flex flex-col gap-8">
      ...
      {!site ? (
        ...
        /* Only what the brief row actually knows: its name, where the build has
           ...
           Deleting lives here rather than on the overview for the same reason:
           it's about this site as a thing you own, not about the build in
           progress. */
        <>
          ...
          <DeleteSiteCard stage={site.stage} />
        </>
      )}
    </div>
  );
