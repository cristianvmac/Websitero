    ...
    <div className="min-h-full p-12">
      ...
      <div className="mb-12 p-6 bg-blue-50 border border-blue-200 rounded-xl">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-slate-700 text-slate-700 font-semibold rounded-lg transition-colors"
        >
   ...
   └─ images/
      └─ blog/            ← featured images uploaded from the CMS`}</pre>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-4 border border-slate-200 rounded-lg">
              ...
              <p className="font-bold text-slate-900 text-sm mb-1">src/admin/config.yml</p>
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-slate-600">
              The collection in{" "}
              <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">src/admin/config.yml</code>{" "}
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900 mb-1">Post Layout &amp; Permalink</h2>
            <p className="text-slate-600">
        ...
        <div className="space-y-6">
          <p className="text-slate-700 text-sm">
            ...
            <code className="bg-slate-100 px-1 rounded">post.html</code> layout, tags each entry{" "}
            <code className="bg-slate-100 px-1 rounded">post</code> so Eleventy collects it, and builds
            the URL from the post&apos;s <code className="bg-slate-100 px-1 rounded">url</code> field.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-4 border border-slate-200 rounded-lg">
              ...
              <p className="text-xs text-slate-600">
                ...
                e.g.{" "}
                <code className="bg-slate-100 px-1 rounded">your-name/your-blog</code>.
              </p>
            </div>
            <div className="p-4 border border-slate-200 rounded-lg">
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        ...
        <div className="space-y-6">
          <p className="text-slate-700 text-sm">
            Out of the box,{" "}
            <code className="bg-slate-100 px-2 py-0.5 rounded text-sm">src/admin/config.yml</code>{" "}
            ships with a placeholder <code className="bg-slate-100 px-1 rounded">backend: git-gateway</code>{" "}
            so the CMS loads locally. Replace that whole <code className="bg-slate-100 px-1 rounded">backend</code>{" "}
          ...
          <ol className="space-y-3 text-sm text-slate-700">
            {[
              ...
              <>
                ...
                <code className="bg-slate-100 px-1.5 py-0.5 rounded">/blog/your-slug/</code>.
              </>,
            ].map((step, i) => (
              <li key={i} className="flex gap-3">
                <span className="shrink-0 w-6 h-6 bg-blue-50 text-slate-700 rounded-full flex items-center justify-center text-xs font-bold">
      ...
      {/* Next Steps */}
      <div className="bg-white border border-slate-200 shadow-sm rounded-2xl p-8 text-slate-700">
