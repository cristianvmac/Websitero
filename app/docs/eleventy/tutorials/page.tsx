...
export default function Tutorials() {
    return (
        <div className="min-h-full p-12">
            <div className="max-w-3xl text-center ml-6">
                {/* Breadcrumb */}
                ...
                <Link
                    ...
                    className="inline-flex items-center px-8 py-3 bg-black text-slate-700 rounded-lg text-base font-medium hover:opacity-90 transition"
                >
                    Get Started
                </Link>
            </div>
