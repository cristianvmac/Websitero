...
// Data
import { examples } from "./templates/wcuTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Why Choose Us</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Why Choose Us</Badge>
            </div>
            ...
            <p style={{
             ...
             // maxWidth: 520,
              fontWeight: 300,
               ...
               A responsive “Why Choose Us” section highlighting key strengths, unique offerings, and client benefits.  
              Includes headline, supporting text, and optional call-to-action, fully adaptable across devices.
            </p>
