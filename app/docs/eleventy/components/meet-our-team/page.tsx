...
// Data
import { examples } from "./templates/motTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Meet Our Team</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Meet Our Team</Badge>
            </div>
            ...
            //  maxWidth: 520,
              ...
              Showcase the people behind your brand with profile cards featuring photos, names, roles, and social links.
              Ideal for building trust and a human connection with your audience.
            </p>
