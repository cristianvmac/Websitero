...
// Data
import { examples } from "./templates/interiorTemplates";
...
// ─────────────────────────────────────────────────────────
export default function InteriorPages() {
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Interior Pages</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Interior Pages</Badge>
            </div>
            ...
            <p style={{
             ...
             // maxWidth: 520,
              ...
              A collection of responsive interior page layouts including content sections, FAQs, and full-detail pages. 
              Designed for clear information hierarchy, rich text presentation, and flexible media integration, with smooth interactions and support for modern UI styling across all screen sizes.
            </p>
