...
<section id="services" class="services">
  <div class="card">
    <picture>
        <img loading="lazy" decoding="async" src="/assets/svgs/service1.svg" alt="icon" width="48" height="48" aria-hidden="true">
    </picture>
    <h2>Service 1</h2>
    <p>
  ...
  <div class="card">
    <picture>
        <img loading="lazy" decoding="async" src="/assets/svgs/service2.svg" alt="icon" width="48" height="48" aria-hidden="true">
    </picture>
    <h2>Service 2</h2>
    <p>
      Write a short description of the service using common search terms. Aim for 1–2 sentences.
  ...
  <div class="card">
    <picture>
      <img loading="lazy" decoding="async" src="/assets/svgs/service3.svg" alt="icon" width="48" height="48" aria-hidden="true">
    </picture>
    <h2>Service 3</h2>
    <p>
      Write a short description of the service using common search terms. Aim for 1–2 sentences.
