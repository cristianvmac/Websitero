...
export default function ComponentsIndex() {
  ...
  return (
    <div className="min-h-full p-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            All components are built with Eleventy—styled, responsive, and ready to drop
      ...
      {/* Footer note */}
      <div className="bg-linear-to-br from-gray-50 to-gray-100 rounded-2xl p-6 border-2 border-gray-200 text-center">
        <p className="text-gray-700">
          All components live in your project&apos;s components folder. Each one is
          documented with live previews and the code you need to copy.
        </p>
      </div>
      </div>
    </div>
