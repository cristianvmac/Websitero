    ...
    <div class="cs-container">
        ...
        <div class="cs-wrapper">
            <picture class="cs-picture">
                <!--Mobile Image-->
                <source media="(max-width: 600px)" srcset="https://images.unsplash.com/photo-1551836022-d5d88e9218df">
                <!--Tablet and above Image-->
                <source media="(min-width: 601px)" srcset="https://images.unsplash.com/photo-1551836022-d5d88e9218df">
                <img loading="lazy" decoding="async" src="https://images.unsplash.com/photo-1551836022-d5d88e9218df" alt="tech conference audience" width="522" height="609" aria-hidden="true">
            </picture>
                ...
                <li class="cs-item">
                    <a href="" class="cs-link">
                        ...
                        <div class="cs-info">
                            ...
                            <span class="cs-time">
                                <img class="cs-icon" src="https://csimg.nyc3.cdn.digitaloceanspaces.com/Images/Icons/orange-clock.svg" alt="icon" width="24" height="24" loading="lazy" decoding="async">
                                09:00am - 04:30pm
                            </span>
                        </div>
                    </a>
