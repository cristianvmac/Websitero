...
// Data
import { examples } from "./templates/formscontactTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Forms & Contact</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Forms Contact</Badge>
            </div>
            ...
            //  maxWidth: 520,
              ...
              A responsive contact form section with input fields, validation states, and submission handling.
              Supports single-column and split layouts, light/dark themes, and optional map or contact info panels.
            </p>
