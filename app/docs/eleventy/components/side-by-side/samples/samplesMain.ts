  ...
  <div class="cs-container">
    ...
    <div class="cs-right">
      <picture class="cs-picture cs-picture1">
          <source media="(max-width: 600px)" srcset="/assets/images/services/sbsreverse.webp">
          <source media="(min-width: 601px)" srcset="/assets/images/services/sbsreverse.webp">
          <img aria-hidden="true" loading="lazy" decoding="async" src="/assets/images/services/sbsreverse.webp" alt="commercial fit-out" width="275" height="132">
      </picture>
    </div>
    ...
    <div class="cs-left">
      ...
      <p class="cs-text">
        ...
        Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. 
        Neque  numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. 
      </p>
    </div>
  </div>
</section>
