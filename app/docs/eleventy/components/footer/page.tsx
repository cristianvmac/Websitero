...
// Data
import { examples } from "./templates/footerTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Footer</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Footer</Badge>
            </div>
            ...
            //  maxWidth: 520,
              ...
              A flexible footer section for organizing navigation links, branding, and supplementary information at the bottom of the page. Designed to be fully responsive and adaptable across layouts and themes, providing a clean and consistent closing experience.
            </p>
