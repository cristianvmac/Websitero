...
// Data
import { examples } from "./templates/ctaTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">CTA</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            //  maxWidth: 520,
              ...
              A flexible call-to-action section designed to capture attention and drive user interaction, featuring a strong headline, supporting text, and prominent action buttons. Built to be fully responsive and adaptable across layouts, themes, and visual styles.
            </p>
