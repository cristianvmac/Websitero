...
<section id="cta">
    ...
    <picture class="cs-picture">
        <source media="(max-width: 600px)" srcset="/assets/images/CTA/cta.jpg">
        <source media="(min-width: 601px)" srcset="/assets/images/CTA/cta.jpg">
        <img decoding="async" src="/assets/images/CTA/cta.jpg" alt="cta image" width="1920" height="1280" aria-hidden="true">
    </picture>
</section>
