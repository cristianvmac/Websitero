...
// Data
import { examples } from "./templates/miscTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">MISC</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <p style={{
             ...
             // maxWidth: 520,
              ...
              A collection of versatile UI components like timetables, location grids, and utility layouts. 
              Designed to be flexible, responsive, and easily integrated into various sections of a modern website.
            </p>
