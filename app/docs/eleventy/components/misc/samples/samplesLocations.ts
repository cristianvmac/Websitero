            ...
            <li class="cs-item">
                ...
                <picture class="cs-background">
                    <img loading="lazy" decoding="async"
                         src="https://images.unsplash.com/photo-1509395176047-4a66953fd231?crop=entropy&cs=tinysrgb&fit=max&w=480&h=425"
                         alt="San Francisco" width="480" height="425">
                </picture>
            </li>
            <li class="cs-item">
                ...
                <picture class="cs-background">
                    <img loading="lazy" decoding="async"
                         src="https://images.unsplash.com/photo-1549692520-acc6669e2f0c?crop=entropy&cs=tinysrgb&fit=max&w=480&h=425"
                         alt="Tokyo" width="480" height="425">
                </picture>
            </li>
            <li class="cs-item">
                ...
                <picture class="cs-background">
                    <img loading="lazy" decoding="async"
                         src="https://images.unsplash.com/photo-1509395176047-4a66953fd231?crop=entropy&cs=tinysrgb&fit=max&w=480&h=425"
                         alt="Berlin" width="480" height="425">
                </picture>
            </li>
            <li class="cs-item">
                ...
                <picture class="cs-background">
                    <img loading="lazy" decoding="async"
                         src="https://images.unsplash.com/photo-1549692520-acc6669e2f0c?crop=entropy&cs=tinysrgb&fit=max&w=480&h=425"
                         alt="Sydney" width="480" height="425">
                </picture>
            </li>
        </ul>
    </div>
