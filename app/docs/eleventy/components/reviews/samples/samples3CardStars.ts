...
<section id="reviews-6">
    <div class="cs-container">
        ...
        <ul class="cs-card-group">
            <li class="cs-item">
                <img class="cs-img" aria-hidden="true" loading="lazy" decoding="async" src="https://csimg.nyc3.digitaloceanspaces.com/Reviews/stars-yellow.svg" alt="profile" width="116" height="20">
                <span class="cs-name">John Doe</span>
                <span class="cs-desc">Florida</span>
            ...
            <li class="cs-item">
                <img class="cs-img" aria-hidden="true" loading="lazy" decoding="async" src="https://csimg.nyc3.digitaloceanspaces.com/Reviews/stars-yellow.svg" alt="profile" width="116" height="20">
                <span class="cs-name">Warren Blake</span>
                <span class="cs-desc">Ohio</span>
                <p class="cs-item-text">
                    Proin massa eros, quis fringilla sagittis. Euismod scelerisque varius sed nec consequat, turpis.
                </p>
            </li>
            <li class="cs-item">
                <img class="cs-img" aria-hidden="true" loading="lazy" decoding="async" src="https://csimg.nyc3.digitaloceanspaces.com/Reviews/stars-yellow.svg" alt="profile" width="116" height="20">
                <span class="cs-name">Thomas Moore</span>
                <span class="cs-desc">Kansas</span>
                <p class="cs-item-text">
                    Proin massa eros, quis fringilla sagittis. Euismod scelerisque varius sed nec consequat, turpis.
                </p>
            </li>
...
@media only screen and (min-width: 0rem) {
    ...
    #reviews-6 .cs-button-solid:before {
        content: "";
        position: absolute;
        height: 100%;
        width: 0%;
    ...
    #reviews-6 .cs-button-solid:hover:before {
        width: 100%;
    }
}
/* Tablet - 768px */
