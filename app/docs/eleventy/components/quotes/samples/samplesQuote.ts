...
<section id="quote">
    <div class="cs-container">
        <div class="cs-content">
            <p class="cs-quote">
                “Innovation is the heartbeat of success. We turn ideas into action and action into impact.”
            </p>
            <span class="cs-name">Alyssa Trent</span>
            <span class="cs-job">Head of Innovation</span>
        </div>
    </div>
    <!--Background Image-->
    <picture class="cs-background">
        <source media="(max-width: 600px)"
                srcset="https://images.pexels.com/photos/3184290/pexels-photo-3184290.jpeg">
        ...
        <img aria-hidden="true" loading="lazy" decoding="async"
                ...
                alt="modern office cityscape" width="360" height="316">
    </picture>
</section>                           
