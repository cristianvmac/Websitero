    ...
    <div className="min-h-full p-12">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
          ...
          <h3 className="text-lg font-bold text-slate-900 mb-2">Purely Static</h3>
        ...
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
          ...
          <h3 className="text-lg font-bold text-slate-900 mb-2">Escaped by Default</h3>
          <p className="text-slate-700">
        ...
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
          <div className="text-4xl mb-3">🔑</div>
          <h3 className="text-lg font-bold text-slate-900 mb-2">Secrets Stay at Build Time</h3>
          <p className="text-slate-700">
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">A Minimal Attack Surface</h2>
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">XSS Protection &amp; the <code className="text-2xl bg-slate-100 px-2 py-1 rounded">safe</code> filter</h2>
            <p className="text-lg text-slate-600">
        ...
        <p className="text-slate-700 mb-4">
          Any value you render with <code className="bg-slate-100 px-2 py-1 rounded">{"{{ }}"}</code> in a
          Nunjucks template is HTML-escaped, so a string like <code className="bg-slate-100 px-2 py-1 rounded">{"<script>"}</code> is
          shown as text instead of executed. The escape hatch is the{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">safe</code> filter &mdash; it outputs
          raw HTML, so only ever pass it content you trust or have sanitized.
        </p>

        <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group overflow-x-auto">
...
<p>{{ userBio | safe }}</p>`,
        ...
        <p className="text-slate-700 mt-6 mb-4">
          ...
          like <code className="bg-slate-100 px-2 py-1 rounded">sanitize-html</code>, then pipe
          through it before <code className="bg-slate-100 px-2 py-1 rounded">safe</code>.
        </p>
...
module.exports = function (eleventyConfig) {
  eleventyConfig.addFilter("sanitize", (html) => sanitizeHtml(html));
        ...
        <p className="text-slate-700 mt-4">
          Now <code className="bg-slate-100 px-2 py-1 rounded">{"<p>{{ userBio | sanitize | safe }}</p>"}</code> renders
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Environment Variables &amp; Secrets</h2>
            <p className="text-lg text-slate-600">
              Eleventy runs in Node at build time, so <code className="bg-slate-100 px-2 py-1 rounded">process.env</code> is
        ...
        <p className="text-slate-700 mb-4">
          You can read <code className="bg-slate-100 px-2 py-1 rounded">process.env</code> in your
          ...
          <code className="bg-slate-100 px-2 py-1 rounded">ELEVENTY_ENV</code> (set to{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">PROD</code> on Netlify builds) to toggle
          minification. Use <code className="bg-slate-100 px-2 py-1 rounded">dotenv</code> for local
          values and keep your <code className="bg-slate-100 px-2 py-1 rounded">.env</code> file out of git.
        </p>

        <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group overflow-x-auto mb-6">
...
ANALYTICS_ID=G-XXXXXXX          # safe to print into the page`,
        ...
        <p className="text-slate-700 mb-4">
          A global data file in <code className="bg-slate-100 px-2 py-1 rounded">src/_data/</code> &mdash;
          alongside the kit&apos;s own <code className="bg-slate-100 px-2 py-1 rounded">client.js</code> &mdash; can use
  ...
  return res.json();
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Forms &amp; Dynamic Features Live Off-Site</h2>
            <p className="text-lg text-slate-600">
  ...
  <button type="submit">Send</button>
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">The Decap CMS Admin</h2>
            <p className="text-lg text-slate-600">
              The one login in this kit lives at{" "}
              <code className="bg-slate-100 px-2 py-1 rounded">/admin/</code> &mdash; but the
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-6">
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
            ...
            <ul className="text-sm text-slate-700 space-y-1.5">
              ...
              <li>• Sanitize CMS-authored HTML before <code className="bg-slate-100 px-1 py-0.5 rounded text-xs">safe</code></li>
              <li>• Run <code className="bg-slate-100 px-1 py-0.5 rounded text-xs">npm run remove-decap</code> if unused</li>
            </ul>
          </div>
        </div>
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Security Headers &amp; CSP</h2>
            <p className="text-lg text-slate-600">
        ...
        <p className="text-slate-700 mb-4">
          ...
          <code className="bg-slate-100 px-2 py-1 rounded">_headers</code> file from your output folder
          (drop it in <code className="bg-slate-100 px-2 py-1 rounded">src/</code> so it copies into{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">public/</code>, next to the kit&apos;s existing{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">_redirects</code>).
        </p>
...
/*
  ...
  Permissions-Policy: geolocation=(), microphone=(), camera=()`,
        ...
        <p className="text-slate-700 mb-4">
          ...
          <code className="bg-slate-100 px-2 py-1 rounded">netlify.toml</code> at the repo root &mdash;
...
[[headers]]
  ...
  [headers.values]
    ...
    X-Frame-Options = "DENY"`,
        ...
        <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-slate-900 font-medium mb-2">🔒 Content Security Policy</p>
          <p className="text-sm text-slate-800">
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Validate Data at Build Time</h2>
            <p className="text-lg text-slate-600">
              Wherever you pull in outside data &mdash; APIs, <code className="bg-slate-100 px-2 py-1 rounded">src/_data</code> files,
        ...
        <p className="text-slate-700 mb-4">
          ...
          or unsafe markup. A schema library like <code className="bg-slate-100 px-2 py-1 rounded">zod</code> works
...
module.exports = async function () {
  ...
  return PostSchema.parse(await res.json());
      ...
      {/* Dependencies */}
      <div className="mb-16 bg-blue-50 rounded-2xl p-8 border border-blue-200">
        <div className="flex items-start gap-4 mb-6">
          <div className="shrink-0 w-12 h-12 bg-blue-50 text-slate-700 rounded-xl flex items-center justify-center shadow-lg">
            <RefreshCw className="w-6 h-6" />
          </div>
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Keep Dependencies Current</h2>
