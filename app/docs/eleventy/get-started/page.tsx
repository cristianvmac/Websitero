  ...
  return (
    <div className="min-h-full p-12">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex gap-2">
                    <code className="bg-gray-100 px-2 py-0.5 rounded text-gray-800 font-mono shrink-0">src/_data/client.js</code>
                    <span>— Site configuration and business info</span>
                  </li>
                  <li className="flex gap-2">
                    <code className="bg-gray-100 px-2 py-0.5 rounded text-gray-800 font-mono shrink-0">src/admin/config.yml</code>
                    <span>— Decap CMS configuration</span>
                  </li>
                  <li className="flex gap-2">
                    <code className="bg-gray-100 px-2 py-0.5 rounded text-gray-800 font-mono shrink-0">src/assets/css/</code>
                    <span>— Styles and design tokens</span>
                  </li>
                  <li className="flex gap-2">
                    <code className="bg-gray-100 px-2 py-0.5 rounded text-gray-800 font-mono shrink-0">.eleventy.js</code>
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-4">A standard Eleventy kit project looks like this:</p>
