    ...
    <section className="min-h-full p-12">
      ...
      <div className="relative overflow-hidden">
        <div className="relative max-w-3xl ml-6">
          ...
          <h1 className="text-slate-900 text-4xl sm:text-5xl font-extrabold mb-5 tracking-tight">
      ...
      <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {platforms.map((p) => (
              <Link
                key={p.name}
                href={p.href}
                className="group flex flex-col rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-sm transition hover:shadow-md hover:-translate-y-0.5 hover:border-blue-200"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={`flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br ${p.accent} text-slate-700 font-extrabold text-lg shadow-sm`}
                  >
                    {p.initial}
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    {p.recommended && (
                      <span className="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-0.5 text-[11px] font-bold text-slate-700 border border-blue-200">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {p.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-flex items-center rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-600 border border-slate-200"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <span className="mt-auto inline-flex items-center gap-1.5 text-sm font-bold text-slate-600">
        ...
        <div className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md hover:-translate-y-0.5">
              ...
              <p className="font-mono text-lg text-slate-900">npx @11ty/eleventy</p>
            </div>
            <div className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md hover:-translate-y-0.5">
              <div className="flex items-center gap-2 mb-3 text-slate-600">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              ...
              <p className="font-mono text-lg text-slate-900">_site</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="font-bold text-slate-800 mb-1">Static output</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                The default — and the only mode. Eleventy prerenders every page to
                HTML at build time, so you deploy the{" "}
                <code className="bg-slate-100 text-slate-800 px-1.5 py-0.5 rounded font-mono text-xs">_site</code>{" "}
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="font-bold text-slate-800 mb-1">Serverless functions</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Add backend logic with{" "}
                <code className="bg-slate-100 text-slate-800 px-1.5 py-0.5 rounded font-mono text-xs">netlify/functions</code>{" "}
                on Netlify or an{" "}
                <code className="bg-slate-100 text-slate-800 px-1.5 py-0.5 rounded font-mono text-xs">api/</code>{" "}
