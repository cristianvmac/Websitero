  ...
  return (
    <section className="min-h-full p-12">
      ...
      <div className="relative overflow-hidden">
        <div className="relative max-w-3xl ml-6">
          ...
          <p className="text-lg text-slate-600 max-w-2xl leading-relaxed">
            ...
            time you push to Git. This kit builds to plain static HTML that
            Vercel serves from its global Edge Network — this guide walks you
      ...
      <div className="max-w-3xl ml-6">
        ...
        <div className="mb-16">
          <SectionHeading eyebrow="Pick one" title="Two ways to deploy" />
          <p className="text-slate-600 mb-6 max-w-2xl">
            ...
            <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 sm:p-7 shadow-sm transition hover:shadow-md">
              ...
              <ol className="space-y-3 mt-auto">
                {[
                  ...
                  <>Vercel detects <strong>Eleventy</strong>. Set the build command to <code className="bg-slate-100 text-slate-800 px-1 py-0.5 rounded font-mono text-xs">npm run build</code> and the output directory to <code className="bg-slate-100 text-slate-800 px-1 py-0.5 rounded font-mono text-xs">public</code>.</>,
...
vercel`}
                ...
                <p className="mt-4 text-xs text-slate-500 leading-relaxed">
                  ...
                  choose <strong>Yes</strong> and set the output directory to{" "}
                  <code className="bg-slate-100 text-slate-700 px-1.5 py-0.5 rounded font-mono">public</code>.
                </p>
              </div>
            </div>
          </div>
