    ...
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
          ...
          <Link href="/docs/eleventy/additional-resources" className="rounded-full py-1 hover:text-slate-600 hover:underline">
        ...
        <h1 className="text-5xl font-bold text-slate-900 mb-4">Learn HTML</h1>
      ...
      >
        ...
        <span className="inline-flex items-center gap-1.5 text-base font-semibold text-slate-600 group-hover:text-slate-700 whitespace-nowrap">
          Visit guide
