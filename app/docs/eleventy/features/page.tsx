...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      href: "/docs/google-business-profile",
      color: "blue",
    ...
    },
    {
      ...
      description: "Add multi-language support with Eleventy's built-in I18n plugin, localized URLs, and translation fallbacks.",
      href: "/docs/eleventy/features/internationalization",
      color: "purple",
