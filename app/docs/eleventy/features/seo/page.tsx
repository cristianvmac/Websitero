    ...
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 leading-relaxed mb-6">
          SEO data is centralized in <code className="bg-slate-100 px-2 py-1 rounded text-lg">src/_data/client.js</code>,
          a single source of truth for your business details, domain, and social links. The base layout&apos;s
          <code className="bg-slate-100 px-2 py-1 rounded text-lg"> &lt;head&gt;</code> builds a complete set of meta and Open Graph tags
          automatically from <code className="bg-slate-100 px-2 py-1 rounded text-lg">client.js</code> and each page&apos;s front matter.
        </p>
      </div>

      {/* The base layout head Section */}
      <div id="setup" className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">
              The Base Layout <code className="text-2xl bg-slate-100 px-2 py-1 rounded">&lt;head&gt;</code>
            </h2>
            <p className="text-lg text-slate-600">
              <code className="bg-slate-100 px-2 py-1 rounded">src/_includes/layouts/base.html</code> builds your SEO tags dynamically from <code className="bg-slate-100 px-2 py-1 rounded">client.js</code> and page front matter
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="shrink-0 w-8 h-8 bg-blue-50 text-slate-700 rounded-full flex items-center justify-center font-bold">1</div>
              <h3 className="text-xl font-bold text-slate-900">Configure Your Site Data</h3>
            </div>
            <p className="text-slate-600 mb-4 ml-11">
              Open <code className="bg-slate-100 px-2 py-1 rounded">src/_data/client.js</code> and fill in your business details. Because it lives in
              <code className="bg-slate-100 px-2 py-1 rounded"> _data</code>, the <code className="bg-slate-100 px-2 py-1 rounded">client</code> object is available in every template.
            </p>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-125 overflow-y-auto">
...
module.exports = {
  ...
  isProduction: process.env.ELEVENTY_ENV === "PROD",
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="shrink-0 w-8 h-8 bg-blue-50 text-slate-700 rounded-full flex items-center justify-center font-bold">2</div>
              <h3 className="text-xl font-bold text-slate-900">How the <code className="text-lg bg-slate-100 px-2 py-1 rounded">&lt;head&gt;</code> Uses It</h3>
            </div>
            <p className="text-slate-600 mb-4 ml-11">
              <code className="bg-slate-100 px-2 py-1 rounded">base.html</code> already wires up description, canonical, and Open Graph tags. Page values
              (<code className="bg-slate-100 px-2 py-1 rounded">title</code>, <code className="bg-slate-100 px-2 py-1 rounded">description</code>, <code className="bg-slate-100 px-2 py-1 rounded">image</code>) come from front matter;
              site values come from <code className="bg-slate-100 px-2 py-1 rounded">client</code>.
            </p>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-150 overflow-y-auto">
  ...
  <title>{{ title }}</title>
          ...
          <div className="ml-11 grid sm:grid-cols-2 gap-4">
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
              <p className="font-bold text-slate-900 mb-2">Built-in Automatically</p>
              <ul className="text-sm text-slate-700 space-y-1.5">
                ...
                <li>• A <code className="bg-slate-200 px-1.5 py-0.5 rounded">{`{% block head %}`}</code> slot for per-page tags</li>
              </ul>
            </div>
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
              <p className="font-bold text-slate-900 mb-2">Social Image Strategy</p>
              <ul className="text-sm text-slate-700 space-y-1.5">
                <li>• <strong>With <code className="bg-slate-200 px-1.5 py-0.5 rounded">image</code>:</strong> uses that path for <code className="bg-slate-200 px-1.5 py-0.5 rounded">og:image</code></li>
                <li>• <strong>Without:</strong> falls back to <code className="bg-slate-200 px-1.5 py-0.5 rounded">/assets/images/logo-small.png</code></li>
                <li>• <strong>Blog posts:</strong> reuse the post&apos;s <code className="bg-slate-200 px-1.5 py-0.5 rounded">image</code> automatically</li>
              </ul>
            </div>
          </div>

          <div className="ml-11 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-2">✅ No Per-Page Wiring Needed</p>
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          <div className="shrink-0 w-12 h-12 bg-blue-50 text-slate-700 rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="shrink-0 w-8 h-8 bg-blue-50 text-slate-700 rounded-full flex items-center justify-center font-bold">1</div>
              <h3 className="text-xl font-bold text-slate-900">Basic Page</h3>
            </div>
            <p className="text-slate-600 mb-4 ml-11">
              Set <code className="bg-slate-100 px-2 py-1 rounded">title</code> and <code className="bg-slate-100 px-2 py-1 rounded">description</code>, extend the base layout,
              and add any page-specific tags in <code className="bg-slate-100 px-2 py-1 rounded">{`{% block head %}`}</code>.
            </p>
...
{% endblock %}`, 3)}
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="shrink-0 w-8 h-8 bg-blue-50 text-slate-700 rounded-full flex items-center justify-center font-bold">2</div>
              <h3 className="text-xl font-bold text-slate-900">Page With a Social Image</h3>
            </div>
            <p className="text-slate-600 mb-4 ml-11">
              Add an <code className="bg-slate-100 px-2 py-1 rounded">image</code> key (an absolute path under <code className="bg-slate-100 px-2 py-1 rounded">/assets</code>) and the
              base layout uses it for <code className="bg-slate-100 px-2 py-1 rounded">og:image</code> instead of the fallback.
            </p>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
              <pre className="whitespace-pre-wrap"><code>{`---
...
{% endblock %}`, 4)}
          ...
          <div className="ml-11 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-2">💡 Recommended for Every Page</p>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              <code className="bg-slate-100 px-2 py-1 rounded">src/_includes/components/home-schema.html</code> builds a LocalBusiness object from
              <code className="bg-slate-100 px-2 py-1 rounded"> client.js</code> (name, phone, email, address, socials). Uncomment its include in <code className="bg-slate-100 px-2 py-1 rounded">index.html</code>:
            </p>
...
<!-- {% include "components/home-schema.html" %} -->`, 5)}
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              Everything is pulled from <code className="bg-slate-100 px-2 py-1 rounded">client</code> — edit your business details once and the schema follows:
            </p>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
...
<script type="application/ld+json">
{
  ...
  {% endif %}
                ...
                className="absolute right-3 top-3 p-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors"
              >
                {copiedStep === 6 ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-slate-400" />}
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              <code className="bg-slate-100 px-2 py-1 rounded">components/post-schema.html</code> builds an Article object from the post&apos;s front matter
              (<code className="bg-slate-100 px-2 py-1 rounded">title</code>, <code className="bg-slate-100 px-2 py-1 rounded">description</code>, <code className="bg-slate-100 px-2 py-1 rounded">image</code>,
              <code className="bg-slate-100 px-2 py-1 rounded"> date</code>, <code className="bg-slate-100 px-2 py-1 rounded">author</code>). Uncomment its include in <code className="bg-slate-100 px-2 py-1 rounded">layouts/post.html</code>:
            </p>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
...
<!-- {% include "components/post-schema.html" %} -->`, 7)}
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              The include builds a full <code className="bg-slate-100 px-2 py-1 rounded">Article</code> object — headline, description, a
              <code className="bg-slate-100 px-2 py-1 rounded"> 1200×630</code> image, published/modified dates (via the <code className="bg-slate-100 px-2 py-1 rounded">isoDate</code> filter),
              the author, and a publisher <code className="bg-slate-100 px-2 py-1 rounded">Organization</code> built from <code className="bg-slate-100 px-2 py-1 rounded">client</code>:
            </p>
...
<script type="application/ld+json">
{
  ...
  {% endif %}
                ...
                className="absolute right-3 top-3 p-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors"
              >
                {copiedStep === 11 ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-slate-400" />}
              </button>
            </div>
          </div>

          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-2">🎯 Rich Snippets Benefits</p>
            <p className="text-sm text-slate-800">
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600">
              Both are generated for you from <code className="bg-slate-100 px-2 py-1 rounded">client.domain</code>
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-600 mb-4">
              The starter uses <code className="bg-slate-100 px-2 py-1 rounded">@quasibit/eleventy-plugin-sitemap</code>, registered in <code className="bg-slate-100 px-2 py-1 rounded">.eleventy.js</code>.
              Its hostname comes from <code className="bg-slate-100 px-2 py-1 rounded">src/config/plugins/sitemap.js</code>:
            </p>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
...
module.exports = {
  sitemap: {
    hostname: client.domain,
                ...
                className="absolute right-3 top-3 p-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors"
              >
                {copiedStep === 8 ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-slate-400" />}
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              <code className="bg-slate-100 px-2 py-1 rounded">src/sitemap.html</code> outputs <code className="bg-slate-100 px-2 py-1 rounded">/sitemap.xml</code> from every page tagged
              <code className="bg-slate-100 px-2 py-1 rounded"> sitemap</code> (a page opts in with <code className="bg-slate-100 px-2 py-1 rounded">tags: &quot;sitemap&quot;</code> in its front matter, like the homepage):
            </p>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
              <pre className="whitespace-pre-wrap"><code>{`---
...
{% sitemap collections.sitemap %}`, 9)}
                className="absolute right-3 top-3 p-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors"
              >
                {copiedStep === 9 ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-slate-400" />}
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              <code className="bg-slate-100 px-2 py-1 rounded">src/robots.html</code> renders <code className="bg-slate-100 px-2 py-1 rounded">/robots.txt</code> and points crawlers at your sitemap:
            </p>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
              <pre className="whitespace-pre-wrap"><code>{`---
...
Sitemap: {{ client.domain }}/sitemap.xml`, 10)}
                className="absolute right-3 top-3 p-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors"
              >
                {copiedStep === 10 ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-slate-400" />}
              </button>
            </div>
          </div>

          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-2">📍 Submit Your Sitemap</p>
