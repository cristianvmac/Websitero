    ...
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-gray-600 mb-8">
          ...
          kit runs Eleventy 3 with a CommonJS <code className="bg-gray-100 px-1.5 py-0.5 rounded text-lg">.eleventy.js</code>,
          you load the plugin with a dynamic import, keep English at the site root, and add each new language in
          its own folder with locale-prefixed permalinks. The <code className="bg-gray-100 px-1.5 py-0.5 rounded text-lg">locale_url</code> and
          {" "}<code className="bg-gray-100 px-1.5 py-0.5 rounded text-lg">locale_links</code> filters then keep every link pointing at the right language.
        </p>
      </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              ...
              which ships as ESM, so you can&apos;t <code className="bg-gray-100 px-2 py-0.5 rounded">require()</code> it
              from the CommonJS <code className="bg-gray-100 px-2 py-0.5 rounded">.eleventy.js</code>. Make the config
              function <code className="bg-gray-100 px-2 py-0.5 rounded">async</code> and pull the plugin in with a
              dynamic <code className="bg-gray-100 px-2 py-0.5 rounded">import()</code>:
            </p>
  ...
  return {
    ...
    htmlTemplateEngine: "njk",
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              Keep English where it already lives under <code className="bg-gray-100 px-2 py-0.5 rounded">src/content/</code>,
              and give each new language its own folder. This starter builds every URL from each page&apos;s
              {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">permalink</code>, so add the locale prefix there:
            </p>
            <div className="ml-11 bg-gray-900 rounded-lg p-4 font-mono text-xs text-gray-100 relative group">
...
└── content/
    ...
    └── es/                 # Spanish lives under its own /es/ prefix
        ...
        └── contact.html    → /es/contact/`, 2)}
            ...
            <p className="text-gray-600 mb-3 mt-5 ml-11">
              Add a directory data file so every page in the folder shares one <code className="bg-gray-100 px-2 py-0.5 rounded">lang</code> &mdash;
  ...
  "lang": "es"
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              ...
              {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">permalink</code> plus
              {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">{`{% extends %}`}</code>. There&apos;s no
              {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">lang</code> here because
              {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">es.json</code> already set it for the folder:
            </p>
            <div className="ml-11 bg-gray-900 rounded-lg p-4 font-mono text-xs text-gray-100 relative group">
...
{# Your Spanish markup goes in the same blocks as the English pages #}`, 4)}
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              Use the <code className="bg-gray-100 px-2 py-0.5 rounded">locale_url</code> filter to rewrite any path to
...
<a href="{{ "/es/about/" | locale_url("en") }}">About (English)</a>`, 5)}
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border-2 border-gray-200 shadow-sm">
        ...
        <p className="text-gray-600 mb-4">
          The plugin adds <code className="bg-gray-100 px-2 py-0.5 rounded">page.lang</code> to every template &mdash;
          read from the URL&apos;s language code, falling back to your
          {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">defaultLanguage</code>. This starter&apos;s base layout
          currently hardcodes <code className="bg-gray-100 px-2 py-0.5 rounded">lang=&quot;en&quot;</code>; wire it to
          {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">page.lang</code> so it&apos;s right on every locale:
        </p>
  ...
  <head>
    <!-- ... -->
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border-2 border-gray-200 shadow-sm">
        ...
        <p className="text-gray-600 mb-4">
          The <code className="bg-gray-100 px-2 py-0.5 rounded">errorMode</code> option controls how
          {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">locale_url</code> behaves when a translation is missing.
          Use <code className="bg-gray-100 px-2 py-0.5 rounded">&quot;allow-fallback&quot;</code> to serve the default
  ...
  errorMode: "allow-fallback",
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          <div className="bg-gray-50 rounded-xl p-5 border-2 border-gray-200">
            <h3 className="font-bold text-gray-900 mb-1 text-sm">strict</h3>
          ...
          <div className="bg-gray-50 rounded-xl p-5 border-2 border-gray-200">
            <h3 className="font-bold text-gray-900 mb-1 text-sm">never</h3>
            <p className="text-sm text-gray-600">
...
{%- endfor %}
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border-2 border-gray-200 shadow-sm">
        ...
        <p className="text-gray-600 mb-4">
          The collection filters &mdash; <code className="bg-gray-100 px-2 py-0.5 rounded">getNextCollectionItem</code>,
          {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">getPreviousCollectionItem</code>, and
          {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">getCollectionItem</code> &mdash; automatically prefer
          the localized item in the current page&apos;s language, with no extra config. This starter tags blog posts
          with <code className="bg-gray-100 px-2 py-0.5 rounded">post</code>, so in
          {" "}<code className="bg-gray-100 px-2 py-0.5 rounded">layouts/post.html</code>:
        </p>
