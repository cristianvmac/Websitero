        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4 ml-11">
              Keep your Measurement ID with the rest of your site config in <code className="bg-slate-100 px-2 py-0.5 rounded">src/_data/client.js</code>. Because it lives in <code className="bg-slate-100 px-2 py-0.5 rounded">_data</code>, it&apos;s available in every template as <code className="bg-slate-100 px-2 py-0.5 rounded">client.gaId</code>:
            </p>
...
module.exports = {
  ...
  isProduction: process.env.ELEVENTY_ENV === "PROD",
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4 ml-11">
              Drop the gtag snippet into the <code className="bg-slate-100 px-2 py-0.5 rounded">&lt;head&gt;</code> of <code className="bg-slate-100 px-2 py-0.5 rounded">src/_includes/layouts/base.html</code> so every page that extends it is tracked. The <code className="bg-slate-100 px-2 py-0.5 rounded">{`{% if client.isProduction and client.gaId %}`}</code> guard keeps it out of local dev builds:
            </p>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
...
npx @11ty/eleventy --serve`}</code></pre>
            ...
            <ul className="space-y-2 text-slate-700 ml-11 mt-4 list-disc list-inside">
              ...
              <li><span className="font-semibold">Tag Assistant:</span> install the <a href="https://chromewebstore.google.com/detail/tag-assistant-companion/jmekfmbnaedfebfnmakmokmlfpblbfdm" target="_blank" rel="noopener noreferrer" className="text-slate-600 underline font-semibold">Google Tag Assistant</a> extension to confirm the GA4 tag is firing correctly</li>
            </ul>
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-600 mb-4">
              The snippet in <code className="bg-slate-100 px-2 py-0.5 rounded">base.html</code> defines a global <code className="bg-slate-100 px-2 py-0.5 rounded">gtag</code> function on production builds. Guard your calls with <code className="bg-slate-100 px-2 py-0.5 rounded">window.gtag</code> so nothing throws in local dev, then fire an event on any interaction:
            </p>
  ...
  <!-- form fields -->
      ...
      <div className="mb-12 p-6 bg-blue-50 border border-blue-200 rounded-xl">
        ...
        <ul className="space-y-2 text-slate-700">
          ...
          <li>• For compliant tracking, use <a href="https://developers.google.com/tag-platform/security/guides/consent" target="_blank" rel="noopener noreferrer" className="text-slate-700 underline font-semibold">Google Consent Mode</a></li>
