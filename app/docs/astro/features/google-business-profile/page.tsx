  ...
  return (
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-2xl text-slate-600 leading-relaxed mb-2 max-w-4xl mx-auto">
          Your customers are searching for local businesses right now. 
        </p>
        
        <p className="text-xl text-slate-700 mb-8 max-w-3xl mx-auto">
          If you&apos;re not in the top results, you&apos;re invisible.
        </p>
      ...
      <div id="setup-guide" className="mb-16 scroll-mt-24 bg-white rounded-3xl p-8 md:p-12 border border-slate-200 shadow-sm">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          {[
            ...
            <div
              key={index}
              className="flex items-start gap-5 p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 hover:bg-blue-50/40 transition-all"
            >
      ...
      {/* Free Audit CTA */}
      <div id="audit" className="scroll-mt-24 bg-slate-50 border border-slate-200 rounded-3xl p-4 md:p-4 text-slate-700 text-center">
