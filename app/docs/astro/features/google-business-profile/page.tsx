  ...
  return (
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-2xl text-gray-600 leading-relaxed mb-2 max-w-4xl mx-auto">
      ...
      {/* Free Audit CTA */}
      <div id="audit" className="scroll-mt-24 bg-linear-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-3xl p-4 md:p-4 text-gray-700 text-center">
