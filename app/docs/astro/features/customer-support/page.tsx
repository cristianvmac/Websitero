        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              Open <code className="bg-gray-100 px-2 py-1 rounded">src/data/client.ts</code> and add a support config alongside the existing exports:
            </p>
...
export const SUPPORT = {
  ...
  crispWebsiteId: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", // Your Crisp Website ID
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              Open your layout <code className="bg-gray-100 px-2 py-1 rounded">src/layouts/BaseLayout.astro</code>, import the config in the frontmatter, and add the Crisp loader inside the <code className="bg-gray-100 px-2 py-0.5 rounded">&lt;head&gt;</code> (Crisp&apos;s recommended spot). Because the starter ships Astro&apos;s <code className="bg-gray-100 px-2 py-0.5 rounded">&lt;ClientRouter /&gt;</code>, boot it on <code className="bg-gray-100 px-2 py-0.5 rounded">astro:page-load</code> so the widget survives client-side navigation:
            </p>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Following the starter&apos;s component-per-folder convention, create <code className="bg-gray-100 px-2 py-1 rounded">src/components/SupportButton/SupportButton.astro</code>:
            </p>
