    ...
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 leading-relaxed mb-6">
          SEO data is centralized in <code className="bg-slate-100 px-2 py-1 rounded text-lg">src/data/client.ts</code>,
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600">
              <code className="bg-slate-100 px-2 py-1 rounded">src/components/Meta/Meta.astro</code> provides comprehensive SEO coverage, automatically included in BaseLayout
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.label} className="flex items-start gap-2.5 text-slate-700">
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600">
              BaseLayout accepts simple props with sensible defaults from <code className="bg-slate-100 px-2 py-1 rounded">client.ts</code>
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-slate-900">Props Interface</h3>
            </div>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group overflow-x-auto">
  ...
  heroImage?: HeroImage;  // Optional social sharing image
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-slate-900">Basic Page (uses defaults)</h3>
            </div>
            <p className="text-slate-600 mb-4 ml-11">
              Pass just a title and description &mdash; everything else falls back to <code className="bg-slate-100 px-2 py-1 rounded">client.ts</code>.
            </p>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group overflow-x-auto">
...
>
  <!-- Page content -->
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="shrink-0 w-8 h-8 bg-blue-50 text-slate-700 rounded-full flex items-center justify-center font-bold">3</div>
              <h3 className="text-xl font-bold text-slate-900">Page With Social Image</h3>
            </div>
            <p className="text-slate-600 mb-4 ml-11">
              Optimize an image with <code className="bg-slate-100 px-2 py-1 rounded">getImage</code> and pass it as <code className="bg-slate-100 px-2 py-1 rounded">heroImage</code>.
            </p>
            <div className="ml-11 bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group overflow-x-auto">
...
>
  <!-- Page content -->
          ...
          <div className="ml-11 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-2">💡 Sensible Defaults</p>
        ...
        <div className="space-y-6">
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg">
            ...
            <p className="text-sm text-slate-700">
              Edit <code className="bg-slate-200 px-1.5 py-0.5 rounded">src/components/Meta/Meta.astro</code> to add properties like
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              ...
              specific page, use the <code className="bg-slate-100 px-2 py-1 rounded">schema</code> slot &mdash; no component changes needed.
            </p>
  ...
  <!-- Page content -->
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4">
              ...
              (<code className="bg-slate-100 px-2 py-1 rounded">localBusinessSchema.js</code>, <code className="bg-slate-100 px-2 py-1 rounded">blogPostingSchema.js</code>).
            </p>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
    ...
    mainEntity: faqs.map((item) => ({
      ...
      acceptedAnswer: {
        ...
        text: item.answer,
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900 mb-2">Usage in a Page</h3>
            <div className="bg-slate-900 rounded-lg p-4 font-mono text-xs text-slate-100 relative group max-h-96 overflow-y-auto">
              <pre className="whitespace-pre-wrap"><code>{`---
...
<BaseLayout title="FAQ" description="Frequently asked questions">
  ...
  <!-- Page content -->
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-2">🎯 Multiple Schemas</p>
            <p className="text-sm text-slate-800">
