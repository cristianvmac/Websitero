        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Navigation</Badge>
            </div>
            ...
            <p style={{
             ...
             // maxWidth: ,
              ...
              A responsive navigation header with logo slot and menu items.
              Collapses into a slide-over drawer on mobile, supports light and
              dark color schemes, and an optional background fill.
            </p>
          ...
          {examples.map((example, i) => (
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 10 }}>
                ...
                <h2 style={{ fontSize: 25, fontWeight: 500, letterSpacing: "-0.01em" }}>
                  {example.title}
                </h2>
              </div>
