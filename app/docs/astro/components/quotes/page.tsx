...
// Data
import { examples } from "./templates/quotesTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Quotes</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Quotes</Badge>
            </div>
            ...
            <p style={{
             ...
             // maxWidth: 520,
              ...
              A responsive quotes section for showcasing testimonials, statements, or brand messages. 
              Supports various layouts including simple quotes and interactive sliders, with full responsiveness and theme adaptability.
            </p>
