...
@media only screen and (min-width: 0rem) {
    ...
    #cs-footer-10 .cs-li:last-of-type {
        margin-bottom: 0;
    }
    #cs-footer-10 .cs-link {
        /* 16px - 20px */
    ...
    #cs-footer-10 .cs-link:hover:before {
        width: 100%;
    }
    #cs-footer-10 .cs-link:before {
        /* top right box */
        content: "";
        width: 0%;
        height: 0.1875rem;
