    ...
    <div id="blog-listing">
      <div class="cs-container">
          ...
          <article class="cs-article">
              <Picture src={blogImage1} alt="Laptop and notebook on a desk" width={2250} height={1500} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-article-image" }} />
              <div class="cs-article-group">
                  <div class="cs-author-group">
                      <Picture src={janeAvatar} alt="Author avatar" width={32} height={32} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-author-img" }} />
          ...
          <article class="cs-article">
              <Picture src={blogImage2} alt="Team collaborating around a table" width={2250} height={1500} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-article-image" }} />
              <div class="cs-article-group">
                  <div class="cs-author-group">
                      <Picture src={marcusAvatar} alt="Author avatar" width={32} height={32} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-author-img" }} />
          ...
          <article class="cs-article">
              <Picture src={blogImage3} alt="Code on a computer screen" width={2250} height={1500} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-article-image" }} />
              <div class="cs-article-group">
                  <div class="cs-author-group">
                      <Picture src={priyaAvatar} alt="Author avatar" width={32} height={32} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-author-img" }} />
       ...
       <!--Featured-->
        <div class="cs-featured-group">
          ...
          <a class="cs-sidebar-link" href="#">
              <Picture src={featuredImage1} alt="Mountain landscape" width={60} height={60} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-sidebar-img" }} />
          ...
          <a class="cs-sidebar-link" href="#">
              <Picture src={featuredImage2} alt="City skyline at night" width={60} height={60} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-sidebar-img" }} />
              <div class="cs-content-group">
          ...
          <a class="cs-sidebar-link" href="#">
              <Picture src={featuredImage3} alt="Coffee cup beside a keyboard" width={60} height={60} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-sidebar-img" }} />
              <div class="cs-content-group">
