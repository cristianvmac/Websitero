...
// Data
import { examples } from "./templates/eventsTemplates";
        ...
        <div style={{
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Events</Badge>
            </div>
            ...
            <p style={{
              ...
              A flexible events section for showcasing upcoming schedules, sessions, or timelines with structured layouts. Includes headings, descriptions, and interactive event listings, designed to be responsive and easily adaptable across different screen sizes and themes.
            </p>
