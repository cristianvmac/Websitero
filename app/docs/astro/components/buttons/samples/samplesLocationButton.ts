...
<a class="cs-button" href="mailto:info@example.com">
    <!-- Icon uses the Astro <Image /> component -->
    <picture class="cs-wrapper">
        <Image class="cs-icon" src={pinIcon} alt="icon" width={24} height={24} />
    </picture>
    <div class="cs-info">
        <span class="cs-header">Visit Us At</span>
        <span class="cs-link-content">Your Business Location</span>
    </div>
</a>
