...
// Data
import { examples } from "./templates/buttonsTemplates";
        ...
        <div style={{
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Buttons</Badge>
            </div>
            ...
            <p style={{
              ...
              A collection of modern, reusable button components designed for clarity and interaction. Includes various styles and animations, supports light and dark themes, and adapts seamlessly across screen sizes for consistent, accessible UI design.
            </p>
