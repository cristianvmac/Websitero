...
<ul id="list" class="cs-ul">
    <!-- Icons use the Astro <Image /> component -->
    <li class="cs-li">
        <picture class="cs-li-picture">
            <Image class="cs-li-icon" src={supportIcon} alt="icon" width={32} height={32} />
        </picture>
        <div class="cs-flex">
            <h3 class="cs-h3">Landscape Maintenance</h3>
            <p class="cs-li-text">
                We offer professional landscape maintenance services to keep your outdoor spaces looking their best year-round.
            </p>
        </div>
    </li>
    <li class="cs-li">
        <picture class="cs-li-picture">
            <Image class="cs-li-icon" src={membersIcon} alt="icon" width={32} height={32} />
        </picture>
        <div class="cs-flex">
            <h3 class="cs-h3">Landscape Maintenance</h3>
            <p class="cs-li-text">
    ...
    <li class="cs-li">
        <picture class="cs-li-picture">
            <Image class="cs-li-icon" src={clockIcon} alt="icon" width={32} height={32} />
        </picture>
        <div class="cs-flex">
            <h3 class="cs-h3">Landscape Maintenance</h3>
            <p class="cs-li-text">
