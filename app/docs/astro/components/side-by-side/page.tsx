...
// Data
import { examples } from "./templates/sbsTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Side By Side</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
              ...
              <Badge color="#60a5fa">Side by Side</Badge>
            </div>
            ...
            <p style={{
             ...
             // maxWidth: 520,
              ...
              A flexible side-by-side component that pairs images with content to create structured, engaging sections.
            </p>
