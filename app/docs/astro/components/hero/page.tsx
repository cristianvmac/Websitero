...
// Data
import { examples } from "./templates/heroTemplates";
      ...
      >
        ...
        <div style={{
          ...
          <nav aria-label="Breadcrumb" className="mb-6 flex flex-wrap items-center gap-x-1 gap-y-1 text-base font-normal text-slate-900">
            ...
            <span><LuChevronRight /></span>
            <span aria-current="page">Hero</span>
          </nav>
          {/* ── Page heading ── */}
          <div
          ...
          >
            ...
            <p style={{
             ...
             // maxWidth: 520,
              ...
              A responsive hero section with headline, supporting text, and CTA buttons. 
              Adapts to different screen sizes and supports light/dark themes and optional background visuals.
            </p>
