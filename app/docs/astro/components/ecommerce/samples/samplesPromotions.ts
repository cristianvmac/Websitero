...
<section id="promotions">
  <div class="cs-container">
      <ul class="cs-card-group">
          ...
          <li class="cs-item">
              <Picture src={saltwaterGearImage} alt="saltwater gear promotion" width={630} height={354} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-background" }} />
          ...
          <li class="cs-item">
              <Picture src={newArrivalsImage} alt="new arrivals promotion" width={630} height={354} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-background" }} />
              <div class="cs-content">
