      ...
      <ul class="cs-card-group">
          <li class="cs-item">
              <a href="" class="cs-link">
                  ...
                  <Picture src={watchesImage} alt="wristwatch" width={365} height={201} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-background" }} />
              </a>
          </li>
          <li class="cs-item">
              <a href="" class="cs-link">
                  <span class="cs-category">Sunglasses</span>
                  <Picture src={sunglassesImage} alt="sunglasses" width={365} height={201} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-background" }} />
              </a>
          </li>
          <li class="cs-item">
              <a href="" class="cs-link">
                  <span class="cs-category">Jackets</span>
                  <Picture src={jacketsImage} alt="jacket" width={365} height={201} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-background" }} />
              </a>
          </li>
          <li class="cs-item">
              <a href="" class="cs-link">
                  <span class="cs-category">Sneakers</span>
                  <Picture src={sneakersImage} alt="sneakers" width={365} height={201} formats={["avif", "webp"]} pictureAttributes={{ class: "cs-background" }} />
              </a>
          </li>
      </ul>
  </div>
