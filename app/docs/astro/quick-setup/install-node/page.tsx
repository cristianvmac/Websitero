      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-sm leading-relaxed mb-3">
            Node.js lets your computer run JavaScript code — the same language used to build websites — outside of a web browser. Many popular tools and frameworks (like Astro, Eleventy, React, and others) <strong>require Node.js to be installed first</strong> before you can use them.
          </p>
