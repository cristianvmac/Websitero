...
const providers = [
  {
    ...
    description:
      "Free, industry-standard GA4. Loaded off the main thread with Partytown so tracking never slows your site down. Best for deep reporting, audiences, and conversion funnels.",
    href: "/docs/astro/analytics/google-analytics",
  ...
  },
  {
    ...
    href: "/docs/astro/analytics/vercel-analytics",
    ...
    <div className="min-h-full p-12">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-slate-600 leading-relaxed">
          ...
          working. Websitero supports two great options — pick the one that fits
          your needs, or run both together.
        </p>
      </div>
