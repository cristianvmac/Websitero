      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border-2 border-gray-200 shadow-sm">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              Register the integration and forward <code className="bg-gray-100 px-2 py-0.5 rounded">dataLayer.push</code> so events reach Google Analytics from the worker:
            </p>
      ...
      config: {
        forward: ["dataLayer.push"],
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4 ml-11">
              Add the gtag snippet to the <code className="bg-gray-100 px-2 py-0.5 rounded">&lt;head&gt;</code> of <code className="bg-gray-100 px-2 py-1 rounded">src/layouts/BaseLayout.astro</code> so every page is tracked. Note the <code className="bg-gray-100 px-2 py-0.5 rounded">type=&quot;text/partytown&quot;</code> on both tags and replace <code className="bg-gray-100 px-2 py-0.5 rounded">G-XXXXXXXXXX</code> with your ID:
            </p>
            <div className="ml-11 bg-gray-900 rounded-lg p-4 font-mono text-xs text-gray-100 relative group max-h-96 overflow-y-auto">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Because you forwarded <code className="bg-gray-100 px-2 py-0.5 rounded">dataLayer.push</code> in Step 3, events fired on the main thread are relayed to the Partytown worker. Define a small <code className="bg-gray-100 px-2 py-0.5 rounded">gtag</code> helper, then call it on any interaction:
            </p>
...
<form onsubmit="gtag('event', 'contact_submit')">
  <!-- form fields -->
      ...
      {/* Next Steps */}
      <div className="rounded-2xl p-4 text-gray-900 text-center">
