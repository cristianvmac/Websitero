        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ol className="space-y-2 text-slate-700 ml-11 list-decimal list-inside">
              <li>Make sure your Astro site is deployed on <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="text-slate-600 underline font-semibold">Vercel</a></li>
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4 ml-11">
              Add the official package to your project. It ships an Astro component, so there&apos;s nothing to configure in <code className="bg-slate-100 px-2 py-0.5 rounded">astro.config.mjs</code>:
            </p>
          ...
          <div>
            ...
            <p className="text-slate-600 mb-4 ml-11">
              Import the Astro component and drop <code className="bg-slate-100 px-2 py-0.5 rounded">&lt;Analytics /&gt;</code> into the layout that wraps every page (usually right before the closing <code className="bg-slate-100 px-2 py-0.5 rounded">&lt;/body&gt;</code>). That&apos;s all it takes to track every route:
            </p>
        ...
        <div className="space-y-6">
          <div>
            <p className="text-slate-600 mb-4">
              Use the <code className="bg-slate-100 px-2 py-0.5 rounded">track</code> helper inside an Astro client <code className="bg-slate-100 px-2 py-0.5 rounded">&lt;script&gt;</code> tag. Astro bundles the import for you, so you can call it from any event handler:
            </p>
...
<body>
  ...
  <SpeedInsights />
      ...
      {/* Next Steps */}
      <div className="p-4 text-slate-900 text-center">
