...
export default function BuildMinutes() {
  ...
  return (
    ...
    <div className="max-w-3xl ml-6">
      ...
      {/* Before You Start */}
      <div className="mb-10 p-4 bg-blue-50 border border-blue-200 rounded-xl">
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-base font-bold text-slate-900 mb-2">Run the create command</h3>
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 mb-2">
              Edit <code className="bg-slate-100 px-2 py-0.5 rounded text-sm">src/data/client.ts</code>
            </h3>
            <p className="text-slate-600 mb-3 text-sm">
...
export const client = {
  ...
  domain: "https://yourdomain.com",
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-slate-900 font-medium mb-1">Also update <code className="bg-blue-100 px-1.5 py-0.5 rounded text-sm">astro.config.mjs</code></p>
            <p className="text-sm text-slate-800">
      ...
      <div className="mb-12 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-slate-600">
              The landing page lives at <code className="bg-slate-100 px-2 py-0.5 rounded text-sm">src/pages/index.astro</code> and  the interior pages lives at <code className="bg-slate-100 px-2 py-0.5 rounded text-sm">src/pages/</code>. It&apos;s composed of pre-built components you can swap or edit.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-600 mb-3 text-sm">
              Open <code className="bg-slate-100 px-2 py-0.5 rounded">src/pages/index.astro</code>. 
            </p>
            <p className="text-slate-600 mb-3 text-sm">
              See {" "}
                <Link
          ...
          <div>
            <h3 className="text-base font-bold text-slate-900 mb-3">Editing a section component</h3>
            <p className="text-slate-600 mb-3 text-sm">
              Each section is its own <code className="bg-slate-100 px-2 py-0.5 rounded">.astro</code> file inside <code className="bg-slate-100 px-2 py-0.5 rounded">src/components/</code>.
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-2">
              Output goes to <code className="bg-slate-100 px-1.5 py-0.5 rounded">dist/</code>. Preview it locally with <code className="bg-slate-100 px-1.5 py-0.5 rounded">npm run preview</code>.
            </p>
          </div>
