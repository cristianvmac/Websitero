    ...
    <div className="min-h-full p-12">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16">
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
          ...
          <h3 className="text-lg font-bold text-slate-900 mb-2">Static by Default</h3>
        ...
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
          <div className="text-4xl mb-3">🔑</div>
          <h3 className="text-lg font-bold text-slate-900 mb-2">Secrets Stay Server-Side</h3>
          <p className="text-slate-700">
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">XSS Protection &amp; <code className="text-2xl bg-slate-100 px-2 py-1 rounded">set:html</code></h2>
            <p className="text-lg text-slate-600">
        ...
        <p className="text-slate-700 mb-4">
          Any value you render with <code className="bg-slate-100 px-2 py-1 rounded">{"{ }"}</code> is
          HTML-escaped, so a string like <code className="bg-slate-100 px-2 py-1 rounded">{"<script>"}</code> is
          shown as text instead of executed. The escape hatch is the{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">set:html</code> directive &mdash; it injects
...
<p set:html={userBio} />`}
        ...
        <p className="text-slate-700 mt-6 mb-4">
          ...
          <code className="bg-slate-100 px-2 py-1 rounded">sanitize-html</code> or{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">isomorphic-dompurify</code>.
        </p>
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600">
              Astro uses the <code className="bg-slate-100 px-2 py-1 rounded">PUBLIC_</code> prefix to
        ...
        <p className="text-slate-700 mb-4">
          Only variables prefixed with <code className="bg-slate-100 px-2 py-1 rounded">PUBLIC_</code> are
          inlined into the client bundle. Anything else is available on the server and at build time,
          but is never shipped to visitors. Keep your <code className="bg-slate-100 px-2 py-1 rounded">.env</code> file
          out of git.
        </p>
...
STRIPE_SECRET_KEY=sk_live_xxxxx   # server-only, never sent to the client`}
        ...
        <p className="text-slate-700 mb-4">
          For type-safe variables with validation, use <code className="bg-slate-100 px-2 py-1 rounded">astro:env</code>.
          Declaring a variable as <code className="bg-slate-100 px-2 py-1 rounded">access: &quot;secret&quot;</code> guarantees
    ...
    schema: {
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Built-in CSRF Protection</h2>
            <p className="text-lg text-slate-600">
        ...
        <p className="text-slate-700 mb-4">
          When you handle form <code className="bg-slate-100 px-2 py-1 rounded">POST</code> requests on the
          server, the <code className="bg-slate-100 px-2 py-1 rounded">security.checkOrigin</code> option
          verifies that the request&apos;s <code className="bg-slate-100 px-2 py-1 rounded">Origin</code> header
    ...
    checkOrigin: true, // reject cross-origin form POST/PUT/PATCH/DELETE requests
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        ...
        <p className="text-slate-700 mb-4">
          ...
          <code className="bg-slate-100 px-2 py-1 rounded">public/_headers</code> file; Vercel uses{" "}
          <code className="bg-slate-100 px-2 py-1 rounded">vercel.json</code>.
        </p>
  ...
  return response;
      ...
      <div className="mb-16 bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Validate Every Input</h2>
            <p className="text-lg text-slate-600">
