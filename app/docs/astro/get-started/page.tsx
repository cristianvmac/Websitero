  ...
  return (
    <div className="min-h-full p-12">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-2 text-sm text-slate-700">
                  <li className="flex gap-2">
                    <code className="bg-slate-100 px-2 py-0.5 rounded text-slate-800 font-mono shrink-0">src/data/client.ts</code>
                    <span>— Site configuration and business info</span>
                  </li>
                  <li className="flex gap-2">
                    <code className="bg-slate-100 px-2 py-0.5 rounded text-slate-800 font-mono shrink-0">src/styles/root.css</code>
                    <span>— Design tokens</span>
                  </li>
                  <li className="flex gap-2">
                    <code className="bg-slate-100 px-2 py-0.5 rounded text-slate-800 font-mono shrink-0">public/admin/config.yml</code>
      ...
      <div className="">
        ...
        <p className="text-sm text-slate-500 mb-4">A standard Astro kit project looks like this:</p>
