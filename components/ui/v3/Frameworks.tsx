        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          {FRAMEWORK_ORDER.map((key) => {
            ...
            return (
              <div
                key={key}
                className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl"
              >
                {/* accent top line */}
                <span
                  aria-hidden
