...
const stack: { icon: LucideIcon; label: string; color: string }[] = [
  ...
  { icon: Zap, label: "JS", color: "text-amber-600 bg-amber-50" },
...
const Performance = () => {
  return (
    <section id="performance" className="bg-white px-6 py-24">
      <div className="mx-auto max-w-4xl">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="inline-flex items-center gap-3 rounded-2xl border border-slate-200 bg-white px-6 py-4 shadow-sm">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-[#4588ba] to-[#316994] text-white">
          ...
          <h2 className="text-center text-2xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            Launch your website{" "}
            <span className="bg-linear-to-r from-[#4588ba] to-[#316994] bg-clip-text text-transparent">
              instantly
            </span>
          </h2>
